  ...
  <div class="row text-white mt-5">
    <div class="card bg-info mx-auto" style="width: 25rem;">
      <div class="card-body">
        ...
        <h5 class="card-title"><strong>OWNERS</strong></h5>
        <div class="display-4">{{ DB::table('companies')->count() }}</div>
        <a href="/dashboard/owners"><p class="card-text text-white">See Details <i class="fas fa-angle-double-right ml-2"></i></p></a>
      </div>
    </div>
  ...
  <div class="row text-white mt-5">
    <div class="card bg-warning mx-auto" style="width: 25rem;">
      <div class="card-body">
        ...
        <h5 class="card-title"><strong>ROOMS</strong></h5>
        <div class="display-4">{{ DB::table('jobs')->count() }}</div>
        <a href="/dashboard/rooms"><p class="card-text text-white">See Details <i class="fas fa-angle-double-right ml-2"></i></p></a>
      </div>
    </div>
