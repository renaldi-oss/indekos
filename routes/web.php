...
Route::group(['middleware' => 'auth:company'], function() {
  Route::resource('/owner/rooms', CompanyJobController::class, ['except' => ['show']]);
  Route::get('/owner/rooms/{job:id}/close', [CompanyJobController::class, 'close']);
});
Route::get('/rooms/{job:id}', [CompanyJobController::class, 'show']);
...
Route::get('/register/owner', [RegisterController::class, 'owner'])->middleware('guest:admin,company,applicant');
Route::post('/register/owner', [RegisterController::class, 'ownerRegister'])->middleware('guest:admin,company,applicant');
...
Route::resource('/dashboard/owners', CompanyDashboardController::class)->middleware('auth:admin');
Route::resource('/dashboard/rooms', JobDashboardController::class)->middleware('auth:admin');
